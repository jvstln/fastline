...
import securitSystemsAndEquipmentSolutions from "@/public/images/security-systems-and-equipment-solutions.webp";
...
export const TrainingAndCapacityBuilding = () => {
  ...
  return (
    <section
      ...
      style={{
        background: `linear-gradient(#0008, #0008), url('/images/training-and-capacity-building-2.webp') no-repeat center center/cover`,
      }}
    >
      <motion.div
        initial="initial"
