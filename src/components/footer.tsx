...
const quickLinks: Array<{
...
}> = [
  {
    ...
    links: [
      ...
      {
        name: "Security Risk Assessment & Strategic Planning",
        href: "/services#risk-and-compliance-solutions",
      },
      {
        name: "Security Systems & Equipment Solutions",
        href: "/services#training-and-capacity-building",
      },
      { name: "Quality Management Policy", href: "/quality-policy" },
    ],
  },
  {
    title: "Industries",
